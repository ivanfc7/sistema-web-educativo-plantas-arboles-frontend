...
export const createUser = async (
    ...
    const response = await fetch("https://webgarden-backend.onrender.com/sistemaWeb/api/generar-link", {
        method: "POST", 
...
const BASE_URL = "https://webgarden-backend.onrender.com/sistemaWeb/api";
